SELECT
    ...
    MAX(total_infra_node_count) as total_infra_node_count,
    MAX(total_control_plane_node_count) as total_control_plane_node_count,
    MAX(total_worker_node_count) as total_worker_node_count,
    MAX(total_infra_node_cpu_cores) AS total_infra_node_cpu_cores,
    MAX(total_control_plane_node_cpu_cores) AS total_control_plane_node_cpu_cores,
    MAX(total_worker_node_cpu_cores) AS total_worker_node_cpu_cores,
    MAX(total_infra_node_mem_gb) AS total_infra_node_mem_gb,
    MAX(total_control_plane_node_mem_gb) AS total_control_plane_node_mem_gb,
    MAX(total_worker_node_mem_gb) AS total_worker_node_mem_gb,
