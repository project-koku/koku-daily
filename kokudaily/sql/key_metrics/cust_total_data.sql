SELECT
    ...
    SUM(total_cluster_capacity_core_hours) AS total_cluster_capacity_core_hours,
    MAX(total_cluster_capacity_memory_gb) AS total_cluster_capacity_memory_gb,
    SUM(total_cluster_capacity_memory_gb_hours) AS total_cluster_capacity_memory_gb_hours,
